...
* Датчик освещённости с цифровыс экраном. V 1.0
************************************************** ************************************************** *****/
#include <Arduino.h>
#include <math.h>
#include <Wire.h>
...
const int LIGHTSENSOR_PIN = A2; //SIG pin of Rocker Switch module connect to A0 of IO Shield, that is pin A2 of OPEN-SMART UNO R3
