...
* Простой пример градусника с цифровым дисплеем. V 1.0
************************************************** ************************************************** *****/
#include <Arduino.h>
#include <Wire.h>
...
const int NTC_PIN = A1; //SIG pin of NTC module connect to A1 of IO Shield, that is pin A1 of OPEN-SMART UNO R3
NTC temper(NTC_PIN);
...
void loop() {
    ...
    displayTemperature((char)celsius); //
