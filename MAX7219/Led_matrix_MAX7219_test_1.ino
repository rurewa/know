...
void writeArduinoOnMatrix()
{
  ...
  /* Отображаем символы один за другим с небольшой задержкой*/
  lc.setRow(0,0,a[0]);
  lc.setRow(0,1,a[1]);
  lc.setRow(0,2,a[2]);
  lc.setRow(0,3,a[3]);
...
/*
Эта функция подсвечивает несколько светодиодов в строке.
...
/*
Эта функция подсвечивает несколько светодиоды в столбце.
...
/*
Эта функция включает каждый светодиод на матрице.
