...
int motor_L1, motor_L2, motor_PWM1;
int motor_R1, motor_R2, motor_PWM2;
int SPEED = 155;
//===============================================
// Функция инициализации управления моторами.
void setup_motor_system(int L1, int  L2, int PWM1, int  R1, int R2, int PWM2)
{
  // Заносятся в переменные номера контактов (пинов) Arduino.
  motor_L1 = L1; motor_L2 = L2; motor_PWM1 = PWM1;
  // Для левых и правых моторов робота.
  motor_R1 = R1; motor_R2 = R2; motor_PWM2 = PWM2;
